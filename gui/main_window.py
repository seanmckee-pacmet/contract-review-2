    ...
    def display_results(self, results):
        ...
        for clause in clause_analysis:
            if clause['invoked'] == 'Yes':
                ...
                clause_item.setText(0, f"Clause: {clause['clause']}")
                ...
                for quote in clause['quotes']:
                    ...
                    if 'metadata' in quote and 'clause_identifier' in quote['metadata']:
                        quote_text += f" [Clause Identifier: {quote['metadata']['clause_identifier']}]"
        ...
        self.tree.expandToDepth(1)  # Expand to show clauses, but not quotes
...
class ResultsDisplay(QWidget):
    ...
    def display_results(self, results):
        ...
        # Process clause analysis
        for clause_id, description in self.categories.items():
            ...
            if matching_clause:
                ...
                description_item = QTreeWidgetItem(clause_item)
                description_item.setText(0, self.wrap_text(f"Description: {description}"))
